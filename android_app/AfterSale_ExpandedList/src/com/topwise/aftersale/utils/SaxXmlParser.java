 ...
 *
 */
package com.topwise.aftersale.utils;
...
import com.topwise.aftersale.AfterSale;
...
public class SaxXmlParser {
    ...
    public static void main(String[] args) {
        ...
        List<AfterSale> servers = parser.parse();
        //System.out.println("servers's size is " + servers.size());

        Iterator<AfterSale> iterator = servers.iterator();

        while(iterator.hasNext()) {
            AfterSale server = iterator.next();
