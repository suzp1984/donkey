...
#define PROPERTY_G_SENSOR "board.g_sensor"
#define PROPERTY_M_SENSOR "board.m_sensor"
#define PROPERTY_L_SENSOR "board.l_sensor"
#define PROPERTY_O_SENSOR "board.o_sensor"
                                 ...
                                 struct sensor_t const** list)
{
	...
	for(i=0; i < SENSORS_SUPPORT_COUNT; i++) {
		property_get(brn_sensors[i].property, status, "disabled");
